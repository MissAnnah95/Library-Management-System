...
$authors = ArrayHelper::map(Authors::find()->all(), 'authorId', 'authorName');
?>
...
<div class="row">
    ...
    <?php $form = ActiveForm::begin(); ?>
       ...
       <button type="button" class="btn btn-block btn-success addauthor"><i class="fa fa-plus" aria-hidden="true"></i> Add Author</button>
        ...
        <div class="col-xs-12">  
        	<?= $form->field($model, 'referenceNumber')->textInput(['maxlength' => true,'placeholder'=>'Input Reference NO'])->label(false) ?>
       </div>
 		<div class="col-xs-12">        
